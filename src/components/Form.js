...
export default function Form({
    ...
    return(
        <div className=' bg-primary-900	 px-10 py-50 rounded-3xl border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                ...
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button className='active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-blue-500	 text-white text-lg text-bold'>Iniciar Sesión </button>
                    <button className='flex rounded-xl py-3 border-2 border-gary-100 items-center justify-center gap-2 active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all'>
                ...
                <div className='mt-8 flex justify-center items-center'>
                    ...
                    className='text-violet-500 text-base font-medium ml-2'>Regitrate</button>
                </div>
            </div>
        </div>
    )
